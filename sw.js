// Service worker mínimo: cache do app para uso offline / instalação PWA.
const CACHE='dopamina-v1';
const ASSETS=['./','./index.html','./qrcode.min.js','./icon-512.png','./manifest.webmanifest'];
